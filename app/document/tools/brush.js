        ...
        if (toolbar.mode == toolbar.modes.HALF_BLOCK) {
            ...
            switch (toolbar.mode) {
                ...
                case toolbar.modes.F1_BLOCK:
                    brushes.f1_block_line(mouse.x, mouse.y, x, y, (button == mouse.buttons.LEFT) ? fg : bg, skip_first);
                    break;
    ...
    if (tab_held_down && single_point && last_xy != undefined) {
        ...
        switch (toolbar.mode) {
            ...
            case toolbar.modes.FULL_BLOCK:
                ...
                break;
            case toolbar.modes.F1_BLOCK:
                brushes.f1_block_line(last_xy.x, last_xy.y, x, y, (button == mouse.buttons.LEFT) ? fg : bg);
                break;
